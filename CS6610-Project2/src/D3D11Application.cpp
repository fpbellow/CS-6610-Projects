...
void D3D11Application::Update()
{
	...
	XMFLOAT3 _cameraPosition = { 0.0f, 0.0f, InputHandler::camDistance };
...
void D3D11Application::Render()
{
	...
	_deviceContext->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY::D3D10_PRIMITIVE_TOPOLOGY_POINTLIST);
