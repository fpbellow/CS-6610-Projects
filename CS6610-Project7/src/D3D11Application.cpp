...
void D3D11Application::Update()
{
	...
	XMFLOAT3 lightPosition = XMFLOAT3(1.0f, 2.5f, 1.0f);
	...
	//XMMATRIX lightProj = XMMatrixOrthographicRH(2.0f, 2.0f, 0.001f, 4.0f);
	XMMATRIX lightProj = XMMatrixOrthographicOffCenterRH(-3.0f, 3.0f, -3.0f, 3.0f, 0.01f, 5.0f);
...
void D3D11Application::Render()
{
	...
	_deviceContext->VSSetConstantBuffers(0, 1, &constantBuffers[1]);
	_deviceContext->VSSetConstantBuffers(1, 1, &constantBuffers[2]);
	...
	_deviceContext->VSSetConstantBuffers(0, 3, &constantBuffers[0]);
